...
public record AdminWaitingUserUpdateRequest(
    ...
    public WaitingUserUpdateRequest toWaitingUserUpdateRequest(long id, Store store) {
        return WaitingUserUpdateRequest.builder()
                .id(id)
                .store(store)
                .name(name)
