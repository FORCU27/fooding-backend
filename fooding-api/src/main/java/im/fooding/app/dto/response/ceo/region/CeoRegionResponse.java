package im.fooding.app.dto.response.ceo.region;
...
@Value
@Builder
public class CeoRegionResponse {
    ...
    public static CeoRegionResponse from(Region region) {
        String parentRegionId = region.getParentRegion() != null ?
                region.getParentRegion().getId()
                : null;

        return CeoRegionResponse.builder()
                .id(region.getId())
