...
public class CeoStoreInformationResponse {
    ...
    @Builder
    private CeoStoreInformationResponse(long id, List<String> links, List<StoreFacility> facilities, List<StorePaymentMethod> paymentMethods, Boolean parkingAvailable, StoreParkingType parkingType, StoreParkingChargeType parkingChargeType, Integer parkingBasicTimeMinutes, Integer parkingBasicFee, Integer parkingExtraMinutes, Integer parkingExtraFee, Integer parkingMaxDailyFee) {
        this.id = id;
        this.links = links;
