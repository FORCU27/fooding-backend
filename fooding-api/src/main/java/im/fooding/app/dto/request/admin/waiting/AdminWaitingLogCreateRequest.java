...
public record AdminWaitingLogCreateRequest(
        ...
        public WaitingLogCreateRequest toWaitingLogCreateRequest(StoreWaiting storeWaiting) {
                return new WaitingLogCreateRequest(
                        storeWaiting,
