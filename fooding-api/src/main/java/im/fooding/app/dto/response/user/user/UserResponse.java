package im.fooding.app.dto.response.user.user;
...
public class UserResponse {
    ...
    @Builder
    private UserResponse(long id, String email, String nickname, String phoneNumber, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.email = email;
