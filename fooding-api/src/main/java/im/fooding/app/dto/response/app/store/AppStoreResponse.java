...
public record AppStoreResponse(
        ...
        @Schema(description = "매장 위치")
        String city,

        @Schema(description = "매장 주소")
        String address,

        @Schema(description = "매장 카테코리")
        String category,
        ...
        @Schema(description = "찾아오는 방법")
        String direction,

        @Schema(description = "안내 및 유의 사항")
        String information,

        @Schema(description = "주차 가능 여부")
        boolean isParkingAvailable,

        @Schema(description = "매장 신규오픈 여부")
        boolean isNewOpen,

        @Schema(description = "매장 테이크아웃 여부")
        boolean isTakeOut
) {
