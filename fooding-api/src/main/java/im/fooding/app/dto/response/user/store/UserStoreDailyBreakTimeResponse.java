...
@Getter
@NoArgsConstructor
public class UserStoreDailyBreakTimeResponse {
    ...
    @Builder
    private UserStoreDailyBreakTimeResponse(long id, DayOfWeek dayOfWeek, LocalTime breakStartTime, LocalTime breakEndTime) {
        this.id = id;
    ...
    public static UserStoreDailyBreakTimeResponse of(StoreDailyBreakTime storeDailyBreakTime) {
        return UserStoreDailyBreakTimeResponse.builder()
