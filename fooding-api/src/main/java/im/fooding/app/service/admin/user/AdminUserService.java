...
public class AdminUserService {
    ...
    public Long create(AdminCreateUserRequest request) {
        ...
        User user = userService.create(request.getEmail(), request.getNickname(),
                passwordEncoder.encode(request.getPassword()), request.getPhoneNumber(), request.getGender(), request.getName(), "", null, false);
    ...
    public void update(long id, AdminUpdateUserRequest request) {
        userService.update(id, request.getNickname(), request.getPhoneNumber(), request.getGender(), null, false, "", false, null, request.getAddress(), request.getAddressDetail());
    }
